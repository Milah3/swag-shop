						...
						value: function () {
							...
							if (this.enabled) {
								...
								return (
									...
									(["", "static"].indexOf(A.body.style.position) !== -1 && ["", "static"].indexOf(A.body.parentElement.style.position) !== -1) || ((x.page.bottom = A.body.scrollHeight - b - f), (x.page.right = A.body.scrollWidth - m - a)),
			...
			return (
				this.options.constraints.forEach(function (t) {
					...
					("target" !== d && "both" !== d) || (o < w[1] && "top" === v.top && ((o += u), (v.top = "bottom")), o + f > w[3] && "bottom" === v.top && ((o -= u), (v.top = "top"))),
						"together" === d &&
							("top" === v.top && ("bottom" === y.top && o < w[1] ? ((o += u), (v.top = "bottom"), (o += f), (y.top = "top")) : "top" === y.top && o + f > w[3] && o - (f - u) >= w[1] && ((o -= f - u), (v.top = "bottom"), (y.top = "bottom"))),
							"bottom" === v.top && ("top" === y.top && o + f > w[3] ? ((o -= u), (v.top = "top"), (o -= f), (y.top = "bottom")) : "bottom" === y.top && o < w[1] && o + (2 * f - u) <= w[3] && ((o += f - u), (v.top = "top"), (y.top = "top"))),
